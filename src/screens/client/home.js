...
import { 
  FaCalendarCheck, FaStethoscope, FaVial, 
  FaSyringe, FaBus, FaFileMedical, FaBell, FaUserCircle 
} from 'react-icons/fa';
...
const Home = () => {
  ...
  return (
    <div className="ep-page">
      {/* Header */}
      <div className="ep-page-header ep-justify-between" style={{ borderBottom: 'none', background: 'transparent' }}>
        <div>
        ...
        <div className="ep-flex ep-gap-3">
