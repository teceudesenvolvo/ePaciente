...
const HeaderTop = ({ customTitle, customClick, showBack = true, children }) => {
  ...
  const config = {
    ...
    '/executivo/frotas': { title: 'Monitoramento de Frotas' },
    ...
    '/funcionarios/medicos/online': { title: 'Médicos · Consultas Online' },
    ...
    '/funcionarios/recepcao/pacientes': { title: 'Recepção · Pacientes' },
    '/funcionarios/recepcao/painel': { title: 'Recepção · Painel de Chamadas' },
